...
export default function AIAgentVideoModal() {
  ...
  return (
    <div className="fixed inset-0 z-30 w-screen h-screen bg-black overflow-hidden flex flex-col justify-between animate-fadeIn pt-16">
      ...
      <div className="relative z-20 flex items-center justify-between p-4 md:p-8 pointer-events-auto">
        <div className="flex items-center gap-3 bg-slate-950/90 backdrop-blur-2xl border border-cyan-500/40 px-5 py-3 rounded-2xl shadow-2xl">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-950/90 backdrop-blur-2xl border border-cyan-500/40 text-cyan-300 hover:text-white rounded-xl transition-all cursor-pointer shadow-xl text-xs font-bold uppercase tracking-wider"
          >
      ...
      <div className="relative z-20 p-4 md:p-8 flex flex-col lg:flex-row items-end lg:items-center justify-between gap-6 pointer-events-auto">
        {/* User Microphone Status & Live Gemini Voice Subtitle */}
        <div className="w-full lg:max-w-2xl bg-slate-950/90 backdrop-blur-2xl border border-cyan-500/40 p-6 rounded-3xl text-sm font-mono text-white shadow-2xl space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-cyan-400 tracking-widest uppercase flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-cyan-400 animate-spin" />
              Gemini AI Output
            </span>
            <span className="text-[10px] text-emerald-400 font-mono flex items-center gap-1.5 bg-emerald-950/80 px-2.5 py-1 rounded-full border border-emerald-500/40">
          ...
          <div className="flex items-center gap-3 p-3 bg-slate-900/95 rounded-2xl border border-cyan-500/30 shadow-inner">
        ...
        <div className="w-full lg:w-auto flex flex-wrap lg:flex-col gap-3">
          ...
          <div className="flex gap-3 w-full">
            <button
              ...
              className="flex-1 px-4 py-3 bg-slate-950/90 backdrop-blur-2xl border border-cyan-500/40 text-cyan-300 hover:text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-1.5 cursor-pointer"
            >
